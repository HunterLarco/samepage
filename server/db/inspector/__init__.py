...
def get_models(basemodel=None):
  if not basemodel:
    from ..model import Model
    basemodel = Model
  import itertools
  return [model.__name__ for model in basemodel.__subclasses__()] + list(itertools.chain(*[get_models(model) for model in basemodel.__subclasses__()]))
